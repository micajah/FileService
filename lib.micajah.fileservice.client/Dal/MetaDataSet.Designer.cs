...
VALUES        (@FileUniqueId,@OrganizationId,@DepartmentId,@LocalObjectType,@LocalObjectId,@Name,@SizeInBytes, GETDATE(),@UpdatedBy,@Deleted)";
...
SET                OrganizationId = @OrganizationId, DepartmentId = @DepartmentId, LocalObjectType = @LocalObjectType, LocalObjectId = @LocalObjectId, Name = @Name, 
                         SizeInBytes = @SizeInBytes, UpdatedTime = GETDATE(), UpdatedBy = @UpdatedBy, Deleted = @Deleted
WHERE        (FileUniqueId = @FileUniqueId)";
...
ORDER BY UpdatedDate, Name";
        ...
        public virtual int Insert(string FileUniqueId, System.Guid OrganizationId, System.Guid DepartmentId, string LocalObjectType, string LocalObjectId, string Name, int SizeInBytes, string UpdatedBy, bool Deleted) {
            if ((FileUniqueId == null)) {
                throw new global::System.ArgumentNullException("FileUniqueId");
            }
            else {
        ...
        public virtual int Update(string FileUniqueId, System.Guid OrganizationId, System.Guid DepartmentId, string LocalObjectType, string LocalObjectId, string Name, int SizeInBytes, string UpdatedBy, bool Deleted) {
            if ((FileUniqueId == null)) {
                throw new global::System.ArgumentNullException("FileUniqueId");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[0].Value = ((string)(FileUniqueId));
            }
            this.Adapter.UpdateCommand.Parameters[1].Value = ((System.Guid)(OrganizationId));
            this.Adapter.UpdateCommand.Parameters[2].Value = ((System.Guid)(DepartmentId));
            if ((LocalObjectType == null)) {
                throw new global::System.ArgumentNullException("LocalObjectType");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[3].Value = ((string)(LocalObjectType));
            }
            if ((LocalObjectId == null)) {
                throw new global::System.ArgumentNullException("LocalObjectId");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[4].Value = ((string)(LocalObjectId));
            }
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            ...
            this.Adapter.UpdateCommand.Parameters[6].Value = ((int)(SizeInBytes));
            if ((UpdatedBy == null)) {

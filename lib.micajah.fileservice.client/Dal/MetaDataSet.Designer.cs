...
namespace Micajah.FileService.Client.Dal {
    ...
    public partial class MetaDataSet : global::System.Data.DataSet {
        ...
        public partial class FileDataTable : global::System.Data.TypedTableBase<FileRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public FileRow AddFileRow(string FileUniqueId, System.Guid OrganizationId, System.Guid DepartmentId, string LocalObjectType, string LocalObjectId, string Name, int SizeInBytes, System.DateTime UpdatedTime, string UpdatedBy, bool Deleted, string Checksum, double SizeInKB, System.DateTime UpdatedDate) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public FileRow AddFileRow(string FileUniqueId, System.Guid OrganizationId, System.Guid DepartmentId, string LocalObjectType, string LocalObjectId, string Name, int SizeInBytes, System.DateTime UpdatedTime, string UpdatedBy, bool Deleted, string Checksum, System.DateTime UpdatedDate) {
                FileRow rowFileRow = ((FileRow)(this.NewRow()));
                object[] columnValuesArray = new object[] {
                        FileUniqueId,
                        OrganizationId,
...
namespace Micajah.FileService.Client.Dal.MetaDataSetTableAdapters {
    ...
    public partial class FileTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO Mfs_File
                         (FileUniqueId, OrganizationId, DepartmentId, LocalObjectType, LocalObjectId, Name, SizeInBytes, UpdatedTime, UpdatedBy, Deleted, Checksum)
VALUES        (@FileUniqueId,@OrganizationId,@DepartmentId,@LocalObjectType,@LocalObjectId,@Name,@SizeInBytes,@UpdatedTime,@UpdatedBy,@Deleted,@Checksum)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Checksum", global::System.Data.SqlDbType.VarChar, 32, global::System.Data.ParameterDirection.Input, 0, 0, "Checksum", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE       Mfs_File
SET                OrganizationId = @OrganizationId, DepartmentId = @DepartmentId, LocalObjectType = @LocalObjectType, LocalObjectId = @LocalObjectId, Name = @Name, 
                         SizeInBytes = @SizeInBytes, UpdatedTime = @UpdatedTime, UpdatedBy = @UpdatedBy, Deleted = @Deleted, Checksum = @Checksum
WHERE        (FileUniqueId = @FileUniqueId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        FileUniqueId, OrganizationId, DepartmentId, LocalObjectType, LocalO" +
                "bjectId, Name, SizeInBytes, UpdatedTime, UpdatedBy, Deleted, Checksum\r\nFROM     " +
                "       Mfs_File\r\nWHERE        (FileUniqueId = @FileUniqueId)";
            ...
            this._commandCollection[2].CommandText = @"SELECT        FileUniqueId, OrganizationId, DepartmentId, LocalObjectType, LocalObjectId, Name, SizeInBytes, UpdatedTime, UpdatedBy, Deleted, CONVERT(datetime, 
                         CONVERT(varchar(10), UpdatedTime, 101), 101) AS UpdatedDate, Checksum
FROM            Mfs_File
...
ORDER BY UpdatedDate, Name";
        ...
        public virtual int Insert(string FileUniqueId, System.Guid OrganizationId, System.Guid DepartmentId, string LocalObjectType, string LocalObjectId, string Name, int SizeInBytes, System.DateTime UpdatedTime, string UpdatedBy, bool Deleted, string Checksum) {
            if ((FileUniqueId == null)) {
                throw new global::System.ArgumentNullException("FileUniqueId");
            }
            else {
            ...
            if ((Checksum == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[10].Value = ((string)(Checksum));
            }
        ...
        public virtual int Update(System.Guid OrganizationId, System.Guid DepartmentId, string LocalObjectType, string LocalObjectId, string Name, int SizeInBytes, System.DateTime UpdatedTime, string UpdatedBy, bool Deleted, string Checksum, string FileUniqueId) {
            ...
            if ((Checksum == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[9].Value = ((string)(Checksum));
            }
            if ((FileUniqueId == null)) {
                throw new global::System.ArgumentNullException("FileUniqueId");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[10].Value = ((string)(FileUniqueId));
            }

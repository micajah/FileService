...
namespace Micajah.FileService.Client
{
    ...
    public sealed class ResourceVirtualPathProvider : VirtualPathProvider
    {
        ...
        internal const string ManifestResourceNamePrefix = "Micajah.FileService.Client.Resources.Micajah.FileService";
        internal const string VirtualRootPath = "~/Resources.Micajah.FileService/";
        internal const string VirtualRootShortPath = "~/mfs/";

...
namespace Micajah.FileService.Client.WebService {
    ...
    public partial class FileMtomService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public bool GetFileInfo(string fileId, ref string fullFileName, ref long fileSize, ref int width, ref int height, ref int align, ref string fileMimeType, ref string checksum) {
            ...
            checksum = ((string)(results[7]));
            return ((bool)(results[0]));
        }
        
        /// <remarks/>
        public void GetFileInfoAsync(string fileId, string fullFileName, long fileSize, int width, int height, int align, string fileMimeType, string checksum) {
            this.GetFileInfoAsync(fileId, fullFileName, fileSize, width, height, align, fileMimeType, checksum, null);
        }
        
        /// <remarks/>
        public void GetFileInfoAsync(string fileId, string fullFileName, long fileSize, int width, int height, int align, string fileMimeType, string checksum, object userState) {
            ...
            this.InvokeAsync("GetFileInfo", new object[] {
                        ...
                        align,
                        fileMimeType,
                        checksum}, this.GetFileInfoOperationCompleted, userState);
        }
        ...
        public string PutFile(string applicationGuid, string organizationName, ref string organizationGuid, string departmentName, ref string departmentGuid, [System.Xml.Serialization.XmlElementAttribute(IsNullable=true)] GetFileRequestStreaming getFileResponseStreaming, ref string checksum) {
            ...
            checksum = ((string)(results[3]));
            return ((string)(results[0]));
        }
        
        /// <remarks/>
        public void PutFileAsync(string applicationGuid, string organizationName, string organizationGuid, string departmentName, string departmentGuid, GetFileRequestStreaming getFileResponseStreaming, string checksum) {
            this.PutFileAsync(applicationGuid, organizationName, organizationGuid, departmentName, departmentGuid, getFileResponseStreaming, checksum, null);
        }
        
        /// <remarks/>
        public void PutFileAsync(string applicationGuid, string organizationName, string organizationGuid, string departmentName, string departmentGuid, GetFileRequestStreaming getFileResponseStreaming, string checksum, object userState) {
            ...
            this.InvokeAsync("PutFile", new object[] {
                        ...
                        departmentGuid,
                        getFileResponseStreaming,
                        checksum}, this.PutFileOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        public void PutFileFromUrlAsync(string applicationGuid, string organizationName, string organizationGuid, string departmentName, string departmentGuid, string fileUrl, string checksum) {
            this.PutFileFromUrlAsync(applicationGuid, organizationName, organizationGuid, departmentName, departmentGuid, fileUrl, checksum, null);
        }
        
        /// <remarks/>
        public void PutFileFromUrlAsync(string applicationGuid, string organizationName, string organizationGuid, string departmentName, string departmentGuid, string fileUrl, string checksum, object userState) {
            ...
            this.InvokeAsync("PutFileFromUrl", new object[] {
                        ...
                        departmentGuid,
                        fileUrl,
                        checksum}, this.PutFileFromUrlOperationCompleted, userState);
        }
        ...
        public string UpdateFile(string fileId, [System.Xml.Serialization.XmlElementAttribute(IsNullable=true)] GetFileRequestStreaming getFileResponseStreaming, ref string checksum) {
        ...
        /// <remarks/>
        public void UpdateFileAsync(string fileId, GetFileRequestStreaming getFileResponseStreaming, string checksum) {
            this.UpdateFileAsync(fileId, getFileResponseStreaming, checksum, null);
        }
        
        /// <remarks/>
        public void UpdateFileAsync(string fileId, GetFileRequestStreaming getFileResponseStreaming, string checksum, object userState) {
            ...
            this.InvokeAsync("UpdateFile", new object[] {
                        fileId,
                        getFileResponseStreaming,
                        checksum}, this.UpdateFileOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        public void UpdateFileFromUrlAsync(string fileId, string fileUrl, string checksum) {
            this.UpdateFileFromUrlAsync(fileId, fileUrl, checksum, null);
        }
        
        /// <remarks/>
        public void UpdateFileFromUrlAsync(string fileId, string fileUrl, string checksum, object userState) {
            ...
            this.InvokeAsync("UpdateFileFromUrl", new object[] {
                        fileId,
                        fileUrl,
                        checksum}, this.UpdateFileFromUrlOperationCompleted, userState);
        }

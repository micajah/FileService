...
namespace Micajah.FileService.Tools.UpdateChecksum {
    ...
    public partial class MetaDataSet : global::System.Data.DataSet {
        ...
        public partial class FileDataTable : global::System.Data.TypedTableBase<FileRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public FileRow AddFileRow(string FileUniqueId, System.Guid OrganizationId, System.Guid DepartmentId, string LocalObjectType, string LocalObjectId, string Name, int SizeInBytes, System.DateTime UpdatedTime, string UpdatedBy, bool Deleted, string Checksum) {
...
namespace Micajah.FileService.Tools.UpdateChecksum.MetaDataSetTableAdapters {
    ...
    public partial class FileTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Mfs_File] WHERE (([FileUniqueId] = @Original_FileUniqueId) AND ([OrganizationId] = @Original_OrganizationId) AND ([DepartmentId] = @Original_DepartmentId) AND ([LocalObjectType] = @Original_LocalObjectType) AND ([LocalObjectId] = @Original_LocalObjectId) AND ([Name] = @Original_Name) AND ([SizeInBytes] = @Original_SizeInBytes) AND ([UpdatedTime] = @Original_UpdatedTime) AND ((@IsNull_UpdatedBy = 1 AND [UpdatedBy] IS NULL) OR ([UpdatedBy] = @Original_UpdatedBy)) AND ([Deleted] = @Original_Deleted) AND ((@IsNull_Checksum = 1 AND [Checksum] IS NULL) OR ([Checksum] = @Original_Checksum)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Mfs_File] ([FileUniqueId], [OrganizationId], [DepartmentId], [LocalObjectType], [LocalObjectId], [Name], [SizeInBytes], [UpdatedTime], [UpdatedBy], [Deleted], [Checksum]) VALUES (@FileUniqueId, @OrganizationId, @DepartmentId, @LocalObjectType, @LocalObjectId, @Name, @SizeInBytes, @UpdatedTime, @UpdatedBy, @Deleted, @Checksum);
SELECT FileUniqueId, OrganizationId, DepartmentId, LocalObjectType, LocalObjectId, Name, SizeInBytes, UpdatedTime, UpdatedBy, Deleted, Checksum FROM Mfs_File WHERE (DepartmentId = @DepartmentId) AND (FileUniqueId = @FileUniqueId) AND (OrganizationId = @OrganizationId)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Mfs_File] SET [FileUniqueId] = @FileUniqueId, [OrganizationId] = @OrganizationId, [DepartmentId] = @DepartmentId, [LocalObjectType] = @LocalObjectType, [LocalObjectId] = @LocalObjectId, [Name] = @Name, [SizeInBytes] = @SizeInBytes, [UpdatedTime] = @UpdatedTime, [UpdatedBy] = @UpdatedBy, [Deleted] = @Deleted, [Checksum] = @Checksum WHERE (([FileUniqueId] = @Original_FileUniqueId) AND ([OrganizationId] = @Original_OrganizationId) AND ([DepartmentId] = @Original_DepartmentId) AND ([LocalObjectType] = @Original_LocalObjectType) AND ([LocalObjectId] = @Original_LocalObjectId) AND ([Name] = @Original_Name) AND ([SizeInBytes] = @Original_SizeInBytes) AND ([UpdatedTime] = @Original_UpdatedTime) AND ((@IsNull_UpdatedBy = 1 AND [UpdatedBy] IS NULL) OR ([UpdatedBy] = @Original_UpdatedBy)) AND ([Deleted] = @Original_Deleted) AND ((@IsNull_Checksum = 1 AND [Checksum] IS NULL) OR ([Checksum] = @Original_Checksum)));
SELECT FileUniqueId, OrganizationId, DepartmentId, LocalObjectType, LocalObjectId, Name, SizeInBytes, UpdatedTime, UpdatedBy, Deleted, Checksum FROM Mfs_File WHERE (DepartmentId = @DepartmentId) AND (FileUniqueId = @FileUniqueId) AND (OrganizationId = @OrganizationId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Micajah.FileService.Tools.UpdateChecksum.Properties.Settings.Default.FileService_MetaDataConnectionString;
        }
        ...
        public virtual int Fill(MetaDataSet.FileDataTable dataTable) {
        ...
        public virtual MetaDataSet.FileDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
        ...
        public virtual int Delete(string Original_FileUniqueId, System.Guid Original_OrganizationId, System.Guid Original_DepartmentId, string Original_LocalObjectType, string Original_LocalObjectId, string Original_Name, int Original_SizeInBytes, System.DateTime Original_UpdatedTime, string Original_UpdatedBy, bool Original_Deleted, string Original_Checksum) {
            if ((Original_FileUniqueId == null)) {
                throw new global::System.ArgumentNullException("Original_FileUniqueId");
            }
            else {
                this.Adapter.DeleteCommand.Parameters[0].Value = ((string)(Original_FileUniqueId));
            }
            this.Adapter.DeleteCommand.Parameters[1].Value = ((System.Guid)(Original_OrganizationId));
            this.Adapter.DeleteCommand.Parameters[2].Value = ((System.Guid)(Original_DepartmentId));
            if ((Original_LocalObjectType == null)) {
                throw new global::System.ArgumentNullException("Original_LocalObjectType");
            }
            else {
                this.Adapter.DeleteCommand.Parameters[3].Value = ((string)(Original_LocalObjectType));
            }
            if ((Original_LocalObjectId == null)) {
                throw new global::System.ArgumentNullException("Original_LocalObjectId");
            }
            else {
                this.Adapter.DeleteCommand.Parameters[4].Value = ((string)(Original_LocalObjectId));
            }
            ...
            this.Adapter.DeleteCommand.Parameters[6].Value = ((int)(Original_SizeInBytes));
            this.Adapter.DeleteCommand.Parameters[7].Value = ((System.DateTime)(Original_UpdatedTime));
            ...
            if ((Original_Checksum == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[12].Value = ((string)(Original_Checksum));
            }
        ...
        public virtual int Update(
                    ...
                    bool Deleted, 
                    string Checksum, 
                    string Original_FileUniqueId, 
                    System.Guid Original_OrganizationId, 
                    System.Guid Original_DepartmentId, 
                    string Original_LocalObjectType, 
                    string Original_LocalObjectId, 
                    string Original_Name, 
                    int Original_SizeInBytes, 
            ...
            this.Adapter.UpdateCommand.Parameters[7].Value = ((System.DateTime)(UpdatedTime));
            if ((UpdatedBy == null)) {
            ...
            if ((Checksum == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[10].Value = ((string)(Checksum));
            }
            if ((Original_FileUniqueId == null)) {
                throw new global::System.ArgumentNullException("Original_FileUniqueId");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[11].Value = ((string)(Original_FileUniqueId));
            }
            this.Adapter.UpdateCommand.Parameters[12].Value = ((System.Guid)(Original_OrganizationId));
            this.Adapter.UpdateCommand.Parameters[13].Value = ((System.Guid)(Original_DepartmentId));
            if ((Original_LocalObjectType == null)) {
                throw new global::System.ArgumentNullException("Original_LocalObjectType");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[14].Value = ((string)(Original_LocalObjectType));
            }
            if ((Original_LocalObjectId == null)) {
                throw new global::System.ArgumentNullException("Original_LocalObjectId");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[15].Value = ((string)(Original_LocalObjectId));
            }
            if ((Original_Name == null)) {
                throw new global::System.ArgumentNullException("Original_Name");
            }
            ...
            this.Adapter.UpdateCommand.Parameters[17].Value = ((int)(Original_SizeInBytes));
            this.Adapter.UpdateCommand.Parameters[18].Value = ((System.DateTime)(Original_UpdatedTime));
            if ((Original_UpdatedBy == null)) {
            ...
            if ((Original_Checksum == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[23].Value = ((string)(Original_Checksum));
            }
        ...
        public virtual int Update(
                    ...
                    bool Original_Deleted, 
                    string Original_Checksum) {
            return this.Update(Original_FileUniqueId, Original_OrganizationId, Original_DepartmentId, LocalObjectType, LocalObjectId, Name, SizeInBytes, UpdatedTime, UpdatedBy, Deleted, Checksum, Original_FileUniqueId, Original_OrganizationId, Original_DepartmentId, Original_LocalObjectType, Original_LocalObjectId, Original_Name, Original_SizeInBytes, Original_UpdatedTime, Original_UpdatedBy, Original_Deleted, Original_Checksum);
        }
    }

...
namespace Micajah.FileService.Tools.CopyFilesToFolder {
    ...
    public partial class MetaDataSet : global::System.Data.DataSet {
        ...
        public partial class FileDataTable : global::System.Data.TypedTableBase<FileRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public FileRow AddFileRow(string FileUniqueId, System.Guid OrganizationId, System.Guid DepartmentId, string LocalObjectType, string LocalObjectId, string Name, int SizeInBytes, System.DateTime UpdatedTime, string UpdatedBy, bool Deleted, string Checksum, int UploadStatus) {
            ...
            private void InitClass() {
                ...
                this.columnUploadStatus = new global::System.Data.DataColumn("UploadStatus", typeof(int), null, global::System.Data.MappingType.Element);
        ...
        public partial class FileRow : global::System.Data.DataRow {
            ...
            public int UploadStatus {
                get {
                    try {
                        return ((int)(this[this.tableFile.UploadStatusColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'UploadStatus\' in table \'File\' is DBNull.", e);
                    }
                }
                set {
            ...
            public bool IsUploadStatusNull() {
                return this.IsNull(this.tableFile.UploadStatusColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public void SetUploadStatusNull() {
                this[this.tableFile.UploadStatusColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Micajah.FileService.Tools.CopyFilesToFolder.MetaDataSetTableAdapters {
    ...
    public partial class FileTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Micajah.FileService.Tools.CopyFilesToFolder.Properties.Settings.Default.MetaDataConnectionString;
        }
...
WHERE OrganizationId = @OrganizationId AND DepartmentId = @DepartmentId AND Deleted = 0 AND (LEN(ISNULL(@LocalObjectType, '')) = 0 OR ',' + @LocalObjectType + ',' LIKE '%,' + LocalObjectType + ',%')";
            ...
            this._commandCollection[0].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@LocalObjectType", global::System.Data.SqlDbType.NVarChar, 1024, global::System.Data.ParameterDirection.Input, 0, 0, "", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual MetaDataSet.FileDataTable GetFiles(System.Guid OrganizationId, System.Guid DepartmentId, string LocalObjectType) {

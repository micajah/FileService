...
SELECT DepartmentGuid, OrganizationGuid, Name FROM Department WHERE (DepartmentGuid = @DepartmentGuid)";
    ...
    public partial class FileTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[5].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Checksum", global::System.Data.SqlDbType.VarChar, 32, global::System.Data.ParameterDirection.Input, 0, 0, "Checksum", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        public virtual int UpdateFile(
            ...
            if ((Checksum == null)) {
                ...
                command.Parameters[16].Value = ((string)(Checksum));
            }
            command.Parameters[17].Value = ((bool)(UpdateTransferLog));
            command.Parameters[18].Value = ((int)(ErrorCode));
            global::System.Data.ConnectionState previousConnectionState = command.Connection.State;
            if (((command.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
                command.Connection.Open();
            ...
            if (((command.Parameters[18].Value == null) 
                ...
                ErrorCode = ((int)(command.Parameters[18].Value));
            }
            return returnValue;
        }
